...
EXEPATH="/usr/local/bin/termineter2"
FRMWKBASE="$INSTALLROOT/termineter2"
...
echo "#/bin/sh" > $EXEPATH                                             
echo "FRMWKBASE=$INSTALLROOT/termineter2" >> $EXEPATH
echo "python -B \$FRMWKBASE/termineter2.py \"\$@\"" >> $EXEPATH
chmod +x $EXEPATH
